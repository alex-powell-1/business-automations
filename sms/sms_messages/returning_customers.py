from setup.creds import Company, five_off_coupon
...
rc_1_body = (
    f'Thanks for shopping with {Company.name} yesterday! '
...
rc_2_body = (
    f"Don't forget! You've got a {Company.name} coupon for $5 off your next $30 purchase. "
...
rc_3_choice_1 = (
    f'Thanks for shopping with {Company.name} last week! '
    'We hope your experience was more than satisfactory. '
    f"If you haven't had a chance, please drop us a review here: {Company.review_link} "
)

rc_3_choice_2 = (
    'Thanks for shopping with us last week! '
    f'We hope you had a great experience at {Company.name}. '
    f"If you haven't had a chance, please leave us a review here: {Company.review_link} "
)

# rc_3_choice_3 = (f"It was good seeing you last week! We hope you had a great time at {Company.name}. "
#                  f"If you haven't had a chance, please leave us a review here: {Company.review_link} ")
