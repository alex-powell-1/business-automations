...
class Order:
    ...
    def get_order_details(self):
        ...
        if response.status_code == 200:
            ...
            self.billing_phone = format_phone(
                data["billing_address"]["phone"], mode="clickable"
            )
