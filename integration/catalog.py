...
class Catalog:
    ...
    def process_deletes():
        ...
        delete_count = 0
        delete_targets = Catalog.get_deletion_target(middleware_list=all_mw_products,
    ...
    class Brands:
        ...
        def process_deletes(self):
            ...
            delete_targets = Catalog.get_deletion_target(middleware_list=mw_brand_ids,
    ...
    class Product:
        ...
        def get_product_details(self):
            def get_bound_product_details():
                ...
                # Set parent
                self.parent = [item for item in self.variants if x.is_parent]
        ...
        def process(self):
            ...
            def update():
                ...
                def bc_update_product(payload):
                    ...
                    update_response = requests.put(url=url, headers=creds.test_bc_api_headers, json=payload)
