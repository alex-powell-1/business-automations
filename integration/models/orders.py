...
from setup.utilities import PhoneNumber, Date
...
class ShopifyOrder:
    def __init__(self, node: dict, send_gfc=False):
        ...
        self.customer = ShopifyOrder.Customer(self.node)
        ...
        self.items: list[ShopifyOrder.LineItem] = self.get_items()
...
class CPOrder:
    class LineItem:
        def __init__(self, item: ShopifyOrder.LineItem):
